...
- [open] @normalize-json-error — Normalize JSON error envelopes and exit codes
- [open] @add-version-json — Add version JSON drift contract
- [open] @add-machine-readable — Add machine-readable help JSON
- [open] @expose-config-show — Expose config show and path inspection
